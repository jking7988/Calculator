...
st.set_page_config(
    page_title="Double Oak – Turf Establishment",
    layout="centered",
...
with sidebar_card("Turf Establishment Options", icon="🛠️", bg=("#0f1b12" if ui_dark else "#ffffff"), shadow="0 4px 14px rgba(0,0,0,.06)"):
...
# Treat ft² as “units” for unit cost math
