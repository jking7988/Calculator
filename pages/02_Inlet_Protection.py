...
# --- Page config: FIRST ---
st.set_page_config(
    page_title="Double Oak – Inlet Protection",
    layout="centered",
...
# Hide Streamlit’s built-in page links
...
with sidebar_card("Inlet Protection Options", icon="🛠️", bg=("#0f1b12" if ui_dark else "#ffffff"), shadow="0 4px 14px rgba(0,0,0,.06)"):
